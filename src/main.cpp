...
int main() {
  ...
  auto order4 = std::make_shared<Order>(4, "AAPL", Side::SELL, OrderType::LIMIT,
                                        151.00, 100, now++);
  auto order5 = std::make_shared<Order>(5, "AAPL", Side::SELL, OrderType::LIMIT,
                                        151.50, 200, now++);
  auto order6 = std::make_shared<Order>(6, "AAPL", Side::SELL, OrderType::LIMIT,
                                        152.00, 150, now++);
  ...
  auto order7 = std::make_shared<Order>(7, "AAPL", Side::BUY, OrderType::LIMIT,
                                        151.50, 250, now++);
  ...
  auto order8 = std::make_shared<Order>(8, "AAPL", Side::SELL,
                                        OrderType::MARKET, 0.0, 50, now++);
